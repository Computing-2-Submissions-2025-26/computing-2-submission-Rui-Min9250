...
describe("Cat Cake Kitchen game module", function () {
    describe("coursework API", function () {
        it(
            ...
            function () {
                const game = CatCakeKitchen.create_game(
                    testLevel,
                    heizi,
                    cakes
                );
                ...
                assert.equal(
                    CatCakeKitchen.get_game_status(game),
                    "playing"
                );
            }
        );
    ...
    describe("buildCakeQueue", function () {
        it(
            "uses the level ingredient count to trim each cake recipe",
            function () {
    ...
    describe("moveCat", function () {
        ...
        it("does not move the cat into an obstacle", function () {
            ...
            const blocked = Object.assign({}, state, {
                obstacles: new Map([
                    [CatCakeKitchen.keyFor(0, 1), "counter"]
                ])
            });
    ...
    describe("canReachAllIngredients", function () {
        ...
        it(
            ...
            function () {
                ...
                assert.equal(
                    CatCakeKitchen.canReachAllIngredients(state),
                    false
                );
            }
        );
